...
2. In Claude Code, paste this and say **"set up my second brain"**:
...
3. Open that same folder in Obsidian: **File -> Open folder as vault**. Now you can browse it and see the graph.
